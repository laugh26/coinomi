...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(CadexMain.get(),         new ServerAddress("80.211.7.49", 5013),
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.CADEX_MAIN.getCoinType(), R.drawable.cadex);
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.CADEX_MAIN.getCoinType(), "http://explorer.cadex.xyz/tx/%s");
